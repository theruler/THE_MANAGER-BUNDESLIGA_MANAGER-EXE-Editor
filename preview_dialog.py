...
def show_preview_dialog(
    ...
    *,
    ...
    points_offset        = None,
    subst_gk_changed: bool = False,
    subst_gk_offset = None,
    ...
    summary_lines = [
        ...
        tr("preview.sum.integrity_fix",  value=flag(summary.get("integrity_fix_applied", False))),
        "",
        ...
        tr("preview.sum.substitutions", value=flag(subst_gk_changed)),
        ...
        "",
        tr("preview.sum.extended_layout",  value=flag(summary.get("extended_layout_active", False))),
        "",
